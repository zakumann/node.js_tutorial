...
const parsing = async (page) => {
    ...
    //강의 목록 웹 페이지 html 구조에서 클래스명이 .course_card_item인 html 요소에 강의 정보가 있기 때문에 이 부분에 해당하는 html 요소만 가져옴.
    ...
    $courseList.each((idx, node) => {
        ...
        //수강료를 할인 중인 경우에는 '\수강료\할인된 수강료' 형식 사용
        // 수강료가 무료인 경우는 '무료'
...
//인프런에서 제공하고 있는강의 중 파라미터로 전달한 키워드를 통해 검색된 강의 목록 가져오는 함수
